...
%assign(min_bit_width, 16).
assign(min_bit_width, 10).

list(usable).
% Rules for building circuits.
-P(x, v) | -P(y, v) | P($BIT_AND(x,y), v).
-P(x, v) | -P(y, v) | P($BIT_OR(x,y), v).
-P(x, v) | P($BIT_AND(1111111111,$BIT_NOT(x)), append_inversion(v,x)).
...
P(0000000011, v).  % input 1
P(0000111100, v).  % input 2
P(0011001100, v).  % input 3
P(0101010101, v).  % input 4
...
%-P(0000000111111110, v).

-P(0000000110, v) | -P(0001111000, v) | -P(0110011000, v) | -P(1010101010, v).

%-P(00101111,v) | -P(11010000,v) | -P(11111111,v).
%-P(11110000, v) | -P(11001100, v) | -P(10101010, v).
%-P(00101111,v).
end_of_list.
...
%weight(P(1111111100000000, $(1)), -50).
%weight(P(0000111100001111, $(1)), -50).
%weight(P(1010101010101010, $(1)), -50).
%weight(P(1100110011001100, $(1)), -50)
%end_of_list.
